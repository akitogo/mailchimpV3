...
//File Manager Files methods: Create
   ...
   * @return struct
   *
   * @see https://developer.mailchimp.com/documentation/mailchimp/reference/file-manager/files/#create-post_file_manager_files
   */
...
//File Manager Files methods: Read
   ...
   * @return struct
   *
   * @see https://developer.mailchimp.com/documentation/mailchimp/reference/file-manager/files/#read-get_file_manager_files
   */
   ...
   * @return struct
   *
   * @see https://developer.mailchimp.com/documentation/mailchimp/reference/file-manager/files/#read-get_file_manager_files_file_id
   */
...
//File Manager Files methods: Edit
   ...
   * @return struct
   *
   * @see https://developer.mailchimp.com/documentation/mailchimp/reference/file-manager/files/#edit-patch_file_manager_files_file_id
   */
...
//File Manager Files methods: Delete
   ...
   * @return struct
   *
   * @see https://developer.mailchimp.com/documentation/mailchimp/reference/file-manager/files/#delete-delete_file_manager_files_file_id
   */
